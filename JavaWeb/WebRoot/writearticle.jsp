...
<body>
		...
		<div class="row" id="#">
			<div class="col-sm-8">
				...
				<form action="Putarticle.jsp" method="post" class="form-horizontal">
					...
					<div class="form-group">
						<div class="col-sm-12">
							<textarea class="form-control" name="content1" cols="48" rows="10" placeholder="文章内容"><%=htmlspecialchars(htmlData)%></textarea>
						</div>
					</div>
	...
	<% 
	if(((String) session.getAttribute("tip_articledefeat")) != null){
   	        %>
  	         	<script type="text/javascript">
  	   	  		 alert("发表失败，请重试！");
  	       	    </script>
		...
		session.removeAttribute("tip_articledefeat");
	%>
 		</div>
	</div>
	<!--页脚信息
